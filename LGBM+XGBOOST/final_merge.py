        ...
        for currentslice in lk1[linkid].keys():
            for futureslice in lk1[linkid][currentslice]:
                ...
                if usedftnums < 4:
                    ...
                    count_lk123_lb3 += 1
                    show_lb3 = ''
                    if lk3[linkid][currentslice][futureslice] == 3:
                        show_lb3='3 !!!!!!!!!!!!!!!!!!!!!!!'
                    print(linkid, ' ', currentslice, ' ', futureslice, ' ',
                          ...
                          lklist[1][linkid][currentslice][futureslice],show_lb3)
                    ...
                    #     count_test_not_in_train_links +=1
                        if show:
                            print(linkid,' ',currentslice,' ',futureslice,' ',
                                  ...
                                  lklist[0][linkid][currentslice][futureslice],' ',changelb,
                                  # lklist[1][linkid][currentslice][futureslice],
                                  # lklist[2][linkid][currentslice][futureslice],
...
def getsupportfromhtft(ht_ogalllb_nums,lk3lb):
    ...
    #     return 1
    if lk3index != 0 and ht_ogalllb_nums[lk3index][1] > 8  and ht_ogalllb_nums[0][1] < 1.5*ht_ogalllb_nums[lk3index][1]:
        return 1
    elif ht_ogalllb_nums[lk3index][1] > 8 and ht_ogalllb_nums[1][1]<8:
        return 1
    else:
        return 0
...
if __name__ == '__main__':
    ...
    checkdatafilepath = 'E:/My competitions/didi road condition/code/predictresult/new/check/N2_41.csv'
    linkinfo_check1 = getsubmitdata(checkdatafilepath)
    checkdatafilepath = 'E:/My competitions/didi road condition/code/predictresult/new/check/N2_60.csv'
    ...
    resultfilepath = 'E:/My competitions/didi road condition/code/predictresult/new/vote/47_48_49取众数_融合_finally_2.csv'
